...
{
    /// <inheritdoc />
    public partial class FinalCmsAndAdmin : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CompanyId = table.Column<int>(type: "int", nullable: false),
                    AutoEmployeeNumber = table.Column<bool>(type: "bit", nullable: false),
                    EmployeeNumberPrefix = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EnableBiometricAttendance = table.Column<bool>(type: "bit", nullable: false),
                    PayrollCycle = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StaffSettings", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LeaveDefines", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemReceives", x => x.Id);
                    table.ForeignKey(
